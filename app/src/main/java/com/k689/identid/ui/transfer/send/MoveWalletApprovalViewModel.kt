...
sealed class MoveWalletApprovalEvent : ViewEvent {
    data class Init(val context: Context) : MoveWalletApprovalEvent()
    data class GoBack(val context: Context) : MoveWalletApprovalEvent()
    data class PinChanged(val pin: String) : MoveWalletApprovalEvent()
    data class ConfirmTransfer(val context: Context) : MoveWalletApprovalEvent()
}
...
class MoveWalletApprovalViewModel(
    ...
    private fun loadDocuments() {
        viewModelScope.launch {
            ...
            // Only show documents that the user actually has issued
